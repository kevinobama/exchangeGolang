...
func (v OrdersResource) Show(c buffalo.Context) error {
	...
	return c.Render(200, r.Auto(c, order))
}
...
func (v OrdersResource) New(c buffalo.Context) error {
	return c.Render(200, r.Auto(c, &models.Order{}))
}
...
func (v OrdersResource) Create(c buffalo.Context) error {
	...
	if verrs.HasAny() {
		...
		// correct the input.
		return c.Render(422, r.Auto(c, order))
	}

	// If there are no errors set a success message
	c.Flash().Add("success", "Order was created successfully")

	// and redirect to the orders index page
	return c.Render(201, r.Auto(c, order))
}
...
func (v OrdersResource) Update(c buffalo.Context) error {
	...
	// If there are no errors set a success message
	c.Flash().Add("success", "Order was updated successfully")
...
func (v OrdersResource) Destroy(c buffalo.Context) error {
	...
	c.Flash().Add("success", "Order was destroyed successfully")
